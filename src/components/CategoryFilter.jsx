...
const CategoryFilter = ({ setCurrentCategory }) => {
  return (
    <div>
      <ul className='flex sm:flex-col sm:gap-4 gap-2 overflow-x-scroll sm:overflow-visible pt-2 sm:pt-0 sticky top-8'>
        <li>
          <button
        ...
        <li className='hidden sm:list-item'>
          <div className='flex flex-col items-center gap-2 mt-4'>
            <p className='text-center'>
              A Project By <span className='font-semibold'>Ritik Sharma</span>
            </p>
            ...
            <div className='flex gap-4'>
              <a
                ...
                rel='noreferrer'
              >
                <svg className='h-6 w-6 fill-stone-50 hover:fill-blue-500 transition'>
